...
const authConfig: AuthConfig = {
  ...
  guards: {
    ...
    |--------------------------------------------------------------------------
    |
    | Web guard uses sessions to authenticate HTTP requests. This guard DOES
    | rely on cookies and sessions to authenticate users.
    |
    | Use this guard to authenticate web applications that can rely on
    | cookies/sessions.
    |
    */
    web: {
